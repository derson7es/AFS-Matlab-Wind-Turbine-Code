function WindTurbine_OffshoreAssembly_Submersible(action)
...
%=============================================================    
    ...
    % Calling the next logic instance
    WindTurbine_OffshoreAssembly_Submersible('logical_instance_05'); 
...
%=============================================================    
    ...
    % Calling the next logic instance
    WindTurbine_OffshoreAssembly_Submersible('logical_instance_06');
...
%=============================================================    
    ...
    % Calling the next logic instance
    WindTurbine_OffshoreAssembly_Submersible('logical_instance_07');
...
%=============================================================    
    ...
    % Calling the next logic instance
    WindTurbine_OffshoreAssembly_Submersible('logical_instance_08');
